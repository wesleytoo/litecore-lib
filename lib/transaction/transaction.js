...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://litecore.io/api/lib/transaction#serialization-checks';
...
Transaction.prototype._toBufferWriterWitness = function(writer) {
  writer.writeVarintNum(this.witness.length);
  for (var i = 0; i < this.witness.length; i++) {
    writer.writeVarintNum(this.witness[i].length);
    writer.write(this.witness[i]);
  }
};
